...
// ************************************** constructor ****************************************************
function persondetail(email,country,fname,lname,apartment,address,city,state,zip,phone){
...
let p=document.getElementById("last").addEventListener("click",()=>{
    ...
    let det=new persondetail(email.value,country.value,fname.value,lname.value,apartment.value,address.value,city.value,state.value,zip.value,phone.value);
    if(email.value==""|| country.value=="" || fname.value=="" || lname.value=="" || apartment.value=="" ||address.value=="" || city.value=="" || state.value=="" || zip.value=="" || phone.value==""){
